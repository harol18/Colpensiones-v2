...
namespace Usuarios_planta.Capa_presentacion
{
    public partial class Formdia : Form
    {
        ...
        private void Txtafiliacion2_Validated(object sender, EventArgs e)
        {
            ...
            cmds_dia.recaudo(Txtafiliacion2, Txttotal_recaudo);
        }
        ...
        private void Btn_Actualizar_Click(object sender, EventArgs e)
        {
            ...
            if (validar())
            {
                cmds_dia.actualizar_colp(Txtradicado, Txtcedula, Txtnombre, TxtEstado_cliente, Txtafiliacion1, Txtafiliacion2, Txttotal_recaudo,
                ...
                cmds_dia.historico_colp(Txtradicado, Txtcedula, Txtnombre, TxtEstado_cliente, Txtafiliacion1, Txtafiliacion2, Txttotal_recaudo,
                                   Txtscoring, Txtconsecutivo, cmbfuerza, cmbdestino, Txtrtq, Txtmonto, Txtplazo, Txtcuota, Txttotal, Txtpagare, Txtnit,
                                   Txtcuota_letras, Txttotal_letras, cmbestado, cmbcargue, dtpcargue, cmbresultado,
                                   cmbrechazo, dtpfecha_rpta, Txtplano_dia, Txtplano_pre, TxtN_Plano, Txtcomentarios, TxtIDfuncionario,
                                   TxtNomFuncionario);
        ...
        {
            cmds_dia.buscar_colp(Txtradicado, Txtcedula, Txtnombre, TxtEstado_cliente, Txtafiliacion1, Txtafiliacion2, Txttotal_recaudo, Txtscoring, Txtconsecutivo,
        ...
        private void Btn_Guardar_Click(object sender, EventArgs e)
        {
            ...
            if (validar())
            {
                cmds_dia.Insertar_colp(Txtradicado, Txtcedula, Txtnombre, TxtEstado_cliente, Txtafiliacion1, Txtafiliacion2, Txttotal_recaudo,
                                   Txtscoring, Txtconsecutivo, cmbfuerza, cmbdestino, Txtrtq, Txtmonto, Txtplazo, Txtcuota, Txttotal, Txtpagare, Txtnit,
                                   Txtcuota_letras, Txttotal_letras, cmbestado, cmbcargue, dtpcargue, cmbresultado,
                                   cmbrechazo, dtpfecha_rpta, Txtplano_dia, Txtplano_pre, TxtN_Plano, Txtcomentarios, TxtIDfuncionario,
                                   TxtNomFuncionario);
